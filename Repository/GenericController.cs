...
namespace Repository
{
    ...
    public class GenericController<A, B, C, D, E, F, G, H, I, J> : ControllerBase,
       IGenericController<A, B, C, D, E, F, G, H, I, J> where A : class where B : class
       where C : class where D : class where E : class where F : class where G : class where H : class where I : class where J : class
    {
        private readonly IGenericRepositoryWrapper<A, B, C, D, E, F, G, H, I, J> repositoryWrapper;
        public GenericController(IGenericRepositoryWrapper<A, B, C, D, E, F, G, H, I, J> wrapper)
        {
            repositoryWrapper = wrapper;
        }
    ...
    public class GenericController<A, B, C, D, E, F, G, H, I, J, K> : ControllerBase,
       IGenericController<A, B, C, D, E, F, G, H, I, J, K> where A : class where B : class
       where C : class where D : class where E : class where F : class where G : class where H : class where I : class where J:class where K : class
    {
        private readonly IGenericRepositoryWrapper<A, B, C, D, E, F, G, H, I, J, K> repositoryWrapper;
        public GenericController(IGenericRepositoryWrapper<A, B, C, D, E, F, G, H, I, J, K> wrapper)
        {
            repositoryWrapper = wrapper;
        }
    ...
    public class GenericController<A, B, C, D, E, F, G, H, I, J, K, L> : ControllerBase,
           IGenericController<A, B, C, D, E, F, G, H, I, J, K, L> where A : class where B : class
           where C : class where D : class where E : class where F : class where G : class where H : class where I : class where J : class where K : class where L : class
    {
        private readonly IGenericRepositoryWrapper<A, B, C, D, E, F, G, H, I, J, K, L> repositoryWrapper;
        public GenericController(IGenericRepositoryWrapper<A, B, C, D, E, F, G, H, I, J, K, L> wrapper)
        {
            repositoryWrapper = wrapper;
        }
