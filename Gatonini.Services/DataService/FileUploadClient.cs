...
{
    public class FileUploadClient : BaseVM.BaseViewModel, IUploadAPI
    {

        private readonly HttpClient _client;
        private readonly IUploadAPI _apiRestInstance;
        ...
        public FileUploadClient()
        {
            ...
            //_apiRestInstance = RestService.For<IUploadAPI>(_client);
        }
        ...
        /// <returns>The created file handle when the file was successfully allocated. 
        /// Or null if a file with that name is already being uploaded or an error occurred.</returns>
        ...
        public async Task<bool> EndFileUpload(string fileHandle, long fileSize, bool quitUpload = false)
        {
            try
            {
                await _apiRestInstance.EndFileUpload(fileHandle, quitUpload, fileSize);
                return true;
            }
            catch (Exception)
            {
        ...
        public Task UploadChunk(MediaChunk mediaChunk)
        {
            throw new NotImplementedException();
        }

        public Task EndFileUpload(string fileHandle, bool quitUpload, long fileSize)
        {
            throw new NotImplementedException();
        }

        Task IUploadAPI.UploadFile(MultipartFormDataContent content)
        {
            throw new NotImplementedException();
        }
    }
